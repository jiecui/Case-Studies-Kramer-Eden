function [r, r_CI] = GLM_CFC(Vlo, Vhi, nCtlPts, varargin)
    ...
    % 2025 Modified by Richard J. Cui on Fri 08/08/2025 22:47:30.816626 PM
    % Revision 0.1 on $ Fri 08/08/2025 22:47:30.816626 PM $
    %
    % Rocky Creek Dr. NE
    % Rochester, MN 55906
...
function X = spline_phase0(phase, nCtlPts)
    ...
    for i = 1:length(phase)
        nearest_c_pt_index = max(find(c_pt_times_all <= mod(phase(i), 2 * pi), 1, 'last'));
